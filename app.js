...
swatches.forEach((swatch, index) => {
  ...
  swatch.addEventListener('click', (e) => {
    ...
    // Check if we are on the smae swatch
    ...
    // Gallery
    gsap.to(gallery, {x: -coord, duration: 1, ease:  Back.easeOut.config(1)});
...
tlVideo.fromTo('.product-info-container h3', {opacity: 0}, {opacity: 1, stagger: 0.25, duration: 0.25}, '<');
